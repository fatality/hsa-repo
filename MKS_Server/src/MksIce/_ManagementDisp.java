...
public abstract class _ManagementDisp extends Ice.ObjectImpl implements Management {
    ...
    public final void initManagement( int NumberOfPlanets, int simDuration, double maxPlanetMass, double centralStarMass ) {
        initManagement( NumberOfPlanets, simDuration, maxPlanetMass, centralStarMass, null );
    }

    public static Ice.DispatchStatus ___initManagement( Management __obj, IceInternal.Incoming __inS, Ice.Current __current ) {
    ...
    public void __write( Ice.OutputStream __outS ) {
        ...
        ex.reason = "type MksIce::Management was not generated with stream support";
        throw ex;
    }
