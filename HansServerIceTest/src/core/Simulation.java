...
public class Simulation {
	...
	public double getSpeed(Planet centralStar, Planet planet) {
		double speedMath = (((Management.M - planet.getMass())) / centralStar
				.getMass())
				* Math.sqrt((G * Management.M)
						/ (planet.getPosition()
								.subVec(
										getRSL(centralStar, planet,
												Management.planets))
								.getLenght()));
	...
	public Vector getRSL(Planet centralStar, Planet currPlanet,
