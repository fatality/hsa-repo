...
public final class StartSimPrxHelper extends Ice.ObjectPrxHelperBase implements StartSimPrx
{
    ...
    main(int args)
    {
        main(args, null, false);
    }

    public void
    main(int args, java.util.Map<String, String> __ctx)
    {
        main(args, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    main(int args, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::Simulation::StartSim"))
                {
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::Simulation::StartSim", __ctx))
                {
                    StartSimPrxHelper __h = new StartSimPrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::Simulation::StartSim"))
                {
                    StartSimPrxHelper __h = new StartSimPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::Simulation::StartSim", __ctx))
                {
                    StartSimPrxHelper __h = new StartSimPrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
